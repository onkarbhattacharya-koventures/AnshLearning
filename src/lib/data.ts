...
export const categories: Category[] = [
  {
    id: 'animals',
    name: { en: 'Animals', de: 'Tiere', fr: 'Animaux', es: 'Animales', hi: 'जानवर' },
    Icon: Cat,
    ageGroups: ['1-3', '3-5', '5-8'],
  },
  {
    id: 'home',
    name: { en: 'At Home', de: 'Zuhause', fr: 'À la maison', es: 'En casa', hi: 'घर पर' },
    Icon: House,
    ageGroups: ['1-3', '3-5', '5-8', '8-12'],
  },
  {
    id: 'nature',
    name: { en: 'Nature', de: 'Natur', fr: 'Nature', es: 'Naturaleza', hi: 'प्रकृति' },
    Icon: Sprout,
    ageGroups: ['3-5', '5-8', '8-12'],
  },
  {
    id: 'food',
    name: { en: 'Food', de: 'Essen', fr: 'Nourriture', es: 'Comida', hi: 'खाना' },
    Icon: Utensils,
    ageGroups: ['1-3', '3-5', '5-8'],
  },
  {
    id: 'people',
    name: { en: 'People', de: 'Menschen', fr: 'Gens', es: 'Gente', hi: 'लोग' },
    Icon: Users,
    ageGroups: ['5-8', '8-12', '13-15', '15-18'],
  },
  {
    id: 'school',
    name: { en: 'School', de: 'Schule', fr: 'École', es: 'Escuela', hi: 'स्कूल' },
    Icon: Building,
    ageGroups: ['5-8', '8-12', '13-15'],
  },
  {
    id: 'technology',
    name: { en: 'Technology', de: 'Technologie', fr: 'Technologie', es: 'Tecnología', hi: 'तकनीक' },
    Icon: Rocket,
    ageGroups: ['8-12', '13-15', '15-18'],
  },
  {
    id: 'world',
    name: { en: 'The World', de: 'Die Welt', fr: 'Le monde', es: 'El mundo', hi: 'दुनिया' },
    Icon: Globe,
    ageGroups: ['13-15', '15-18'],
  },
  {
    id: 'sentences',
    name: { en: 'Sentences', de: 'Sätze', fr: 'Phrases', es: 'Oraciones', hi: 'वाक्य' },
    Icon: MessageSquareText,
    ageGroups: ['5-8', '8-12', '13-15', '15-18'],
  },
  {
    id: 'paragraphs',
    name: { en: 'Paragraphs', de: 'Absätze', fr: 'Paragraphes', es: 'Párrafos', hi: 'अनुच्छेद' },
    Icon: AlignLeft,
    ageGroups: ['8-12', '13-15', '15-18'],
  },
  {
    id: 'stories',
    name: { en: 'Stories', de: 'Geschichten', fr: 'Histoires', es: 'Historias', hi: 'कहानियां' },
    Icon: BookOpen,
    ageGroups: ['8-12', '13-15', '15-18'],
  },
];
...
function convertVocabularyToWords(): Word[] {
  const baseWords: Word[] = [
    ...
    { id: 'cat', categoryId: 'animals', text: { en: 'Cat', de: 'Katze', fr: 'Chat', es: 'Gato', hi: 'बिल्ली' }, imageId: 'cat-1', ageGroups: ['1-3', '3-5'] },
    { id: 'dog', categoryId: 'animals', text: { en: 'Dog', de: 'Hund', fr: 'Chien', es: 'Perro', hi: 'कुत्ता' }, imageId: 'dog-1', ageGroups: ['1-3', '3-5'] },
    { id: 'house', categoryId: 'home', text: { en: 'House', de: 'Haus', fr: 'Maison', es: 'Casa', hi: 'घर' }, imageId: 'house-1', ageGroups: ['1-3', '3-5'] },
    { id: 'apple', categoryId: 'food', text: { en: 'Apple', de: 'Apfel', fr: 'Pomme', es: 'Manzana', hi: 'सेब' }, imageId: 'apple-1', ageGroups: ['3-5', '5-8'] },
  ];
...
export const sentences: Sentence[] = [
  { id: 's1', categoryId: 'sentences', text: { en: 'The cat is sleeping on the mat.', de: 'Die Katze schläft auf der Matte.', fr: 'Le chat dort sur le tapis.', es: 'El gato está durmiendo en la alfombra.', hi: 'बिल्ली चटाई पर सो रही है।' }, ageGroups: ['5-8'] },
  { id: 's2', categoryId: 'sentences', text: { en: 'The dog is playing in the garden.', de: 'Der Hund spielt im Garten.', fr: 'Le chien joue dans le jardin.', es: 'El perro está jugando en el jardín.', hi: 'कुत्ता बगीचे में खेल रहा है।' }, ageGroups: ['5-8'] },
  { id: 's3', categoryId: 'sentences', text: { en: 'I like to read books.', de: 'Ich lese gerne Bücher.', fr: 'J\'aime lire des livres.', es: 'Me gusta leer libros.', hi: 'मुझे किताबें पढ़ना पसंद है।' }, ageGroups: ['5-8', '8-12'] },
  { id: 's4', categoryId: 'sentences', text: { en: 'The sun is shining brightly.', de: 'Die Sonne scheint hell.', fr: 'Le soleil brille fort.', es: 'El sol brilla intensamente.', hi: 'सूरज चमक रहा है।' }, ageGroups: ['5-8', '8-12'] },
  { id: 's5', categoryId: 'sentences', text: { en: 'My favorite color is blue.', de: 'Meine Lieblingsfarbe ist blau.', fr: 'Ma couleur préférée est le bleu.', es: 'Mi color favorito es el azul.', hi: 'मेरा पसंदीदा रंग नीला है।' }, ageGroups: ['5-8', '8-12'] },
  { id: 's6', categoryId: 'sentences', text: { en: 'The bird is singing a song.', de: 'Der Vogel singt ein Lied.', fr: 'L\'oiseau chante une chanson.', es: 'El pájaro está cantando una canción.', hi: 'पक्षी गाना गा रहा है।' }, ageGroups: ['5-8'] },
  { id: 's7', categoryId: 'sentences', text: { en: 'The fish is swimming in the water.', de: 'Der Fisch schwimmt im Wasser.', fr: 'Le poisson nage dans l\'eau.', es: 'El pez está nadando en el agua.', hi: 'मछली पानी में तैर रही है।' }, ageGroups: ['5-8'] },
  { id: 's8', categoryId: 'sentences', text: { en: 'I drink milk every morning.', de: 'Ich trinke jeden Morgen Milch.', fr: 'Je bois du lait tous les matins.', es: 'Bebo leche todas las mañanas.', hi: 'मैं हर सुबह दूध पीता हूँ।' }, ageGroups: ['5-8', '8-12'] },
];
...
export const paragraphs: Paragraph[] = [
  {
    ...
    text: {
      ...
      hi: 'एक समय की बात है, एक घाटी में बसे छोटे से गाँव में लिली नाम की एक युवती रहती थी। वह अपनी दयालुता और जानवरों के प्रति अपने प्रेम के लिए जानी जाती थी। हर दिन, वह अपने प्यारे और पंख वाले दोस्तों के साथ समय बिताने के लिए जंगल में चली जाती थी।',
    },
  ...
  },
  {
    ...
    text: {
      ...
      hi: 'स्कूल एक बड़ी, पुरानी इमारत थी जिसकी दीवारें आइवी से ढकी हुई थीं। अंदर कई कक्षाएँ थीं, किताबों से भरी एक लाइब्रेरी और एक खेल का मैदान जहाँ बच्चे दौड़ और खेल सकते थे। शिक्षक दयालु और धैर्यवान थे, और उन्होंने सीखने को मजेदार बना दिया।',
    },
    ageGroups: ['8-12', '13-15'],
  },
];
...
export const stories: Story[] = [
  {
    id: 'story-1',
    categoryId: 'stories',
    title: { en: 'The Magical Tree', de: 'Der magische Baum', fr: 'L\'arbre magique', es: 'El árbol mágico', hi: 'जादुई पेड़' },
    content: {
      ...
      hi: `एक प्राचीन जंगल के बीचों-बीच एक ऐसा पेड़ खड़ा था जो किसी और से अलग था। इसकी पत्तियाँ इंद्रधनुष के सभी रंगों के साथ झिलमिलाती थीं, और कहा जाता था कि इसमें जादुई शक्तियाँ हैं। एक दिन, टॉम नाम के एक जिज्ञासु लड़के ने पेड़ की खोज की और उसका जीवन हमेशा के लिए बदल गया।`,
    },
    ageGroups: ['8-12', '13-15', '15-18'],
  },
  {
    id: 'story-2',
    categoryId: 'stories',
    title: { en: 'The Lost Astronaut', de: 'Der verlorene Astronaut', fr: 'L\'astronaute perdu', es: 'El astronauta perdido', hi: 'खोया हुआ अंतरिक्ष यात्री' },
    content: {
      ...
      hi: `कैप्टन ईवा एक दूर की आकाशगंगा का पता लगाने के मिशन पर थी जब उनका अंतरिक्ष यान उल्कापात की चपेट में आ गया। वह बैंगनी आकाश और चमकते वनस्पतियों वाले एक अजीब ग्रह पर दुर्घटनाग्रस्त हो गई। अब, ईवा को अपने जहाज की मरम्मत करने और पृथ्वी पर लौटने का रास्ता खोजना होगा।`,
    },
    ageGroups: ['13-15', '15-18'],
  },
];
