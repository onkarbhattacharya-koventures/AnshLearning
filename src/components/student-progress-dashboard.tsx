...
export function StudentProgressDashboard({
    ...
    const t = {
        ...
        hi: {
            title: 'मेरी प्रगति',
            subtitle: 'अपनी सीखने की यात्रा को ट्रैक करें',
            totalPoints: 'कुल अंक',
            pointsHint: 'अधिक कमाने के लिए आगे सीखते रहें!',
            currentStreak: 'वर्तमान स्ट्रीक',
            longestStreak: (days: number) => `सबसे लंबी: ${days} दिन`,
            modulesCompleted: 'पुरे हुए मॉड्यूल',
            complete: 'पूर्ण',
            ...
            badgesHint: 'बैज अर्जित करने के लिए मॉड्यूल पूरा करें!',
            allBadges: 'सभी बैज',
            earnedBadges: (count: number) => `आपने ${count} बैज जीते हैं`,
            noBadges: 'अभी तक कोई बैज नहीं मिला। अपना पहला बैज जीतने के लिए सीखना शुरू करें!',
            quizHistory: 'क्विज़ इतिहास',
            quizPerf: 'अपने क्विज़ प्रदर्शन की समीक्षा करें',
            attempts: ' प्रयास: ',
            noQuizzes: 'अभी तक कोई क्विज़ पूरा नहीं हुआ है। अपना पहला क्विज़ लें!',
        }
    }[language];
